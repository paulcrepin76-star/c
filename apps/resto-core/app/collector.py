...
COLLECTORS: list[dict] = [
    ...
    {"slug": "chefs-warehouse", "label": "Chef's Warehouse", "adapter": ADAPTER_AUTH, "status": "extension", "home": "https://www.chefswarehouse.com/login/", "hosts": ["chefswarehouse.com"], "blurb": "You log in (2FA if asked). The extension reads the shop. Itemized PDFs stay the receipt of record."},
