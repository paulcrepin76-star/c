...
Rensaio uses Mihon extensions (not Prowlarr / qBittorrent). Search in the
UI for Bleach, MPD Psycho, Naruto, One Piece, and Shangri-La Frontier, then
subscribe. New chapters land under `/mnt/user/media/book/manga`.
