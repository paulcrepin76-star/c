...
Comics and manga (Rensaio / Kapowarr / Kavita) are on this same Unraid box but are not part of the resto Compose file. See [COMICS.md](COMICS.md). Mylar3 was removed.
